...
import (
	...
	goonvif "github.com/HYBIOT/onvif"
	"github.com/HYBIOT/onvif/device"
	sdk "github.com/HYBIOT/onvif/sdk/device"
	"github.com/HYBIOT/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/HYBIOT/onvif/gosoap for pretty printing response
